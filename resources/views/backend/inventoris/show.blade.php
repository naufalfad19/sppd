        ...
        <div class="modal-body">
          ...
          <div class="col-md-12">
              <div class="kt-form__group--inline">
                ...
                <div class="kt-form__control">
                  <input type="number" min="1" max="{{$data->details->sum('total')-$data->keluar()->sum('total')}}" name="total" class="form-control" placeholder="Enter number" id="n_total_create">
                  @error('total')
                    <div class="form-text text-danger">{{$message}}</div>
                  @enderror
                </div>
        ...
        <div class="modal-body">
          ...
          <div class="col-md-12">
              <div class="kt-form__group--inline">
                ...
                <div class="kt-form__control">
                <input type="number" min="1" name="total" class="form-control" placeholder="Enter number" id="n_total_update_keluar">
                  @error('total')
                    <div class="form-text text-danger">{{$message}}</div>
                  @enderror
                </div>
...
@section('tjs')
  ...
  <script type="text/javascript">
    ...
    function editmodalkeluar(keluar) {
      emptyform();
      $("#d_tanggal_update_keluar").val(keluar.tanggal);
      subtotal1 = "{{$data->details->sum('total')-$data->keluar()->sum('total')}}";
      subtotal2 = keluar.total;
      total = parseInt(subtotal1)+parseInt(subtotal2);
      $("#n_total_update_keluar").val(keluar.total).attr('max', total);
      $("#k_keterangan_update_keluar").val(keluar.keterangan).trigger('change');
