...
<body>
    ...
    <br>
        <div class="row" style="margin-bottom:50px;">
          ...
          <table border="0" width="1200px" cellpadding="7"> 
            ...
            <tr>
                <td>Lampiran Surat Perintah Nomor</td>
                <td>:</td>
        ...
        <table  border="0"width="2000px"cellpadding="7">
            <tr>
                ...
                <td style="width:500px">{{$data->suratTugas->sppd->tempat_berangkat}}, <?php echo tgl_indo(date_format($data->suratTugas->created_at,'Y-m-d'));?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><br><br><br>({{$pejabat->nama_bp}})</td>
                <td><br><br><br>({{$data->pegawai->name}})</td>
            </tr>
            <tr>
                <td>NIP. {{$pejabat->nip_bp}}</td>
        ...
        <font size="4"><b><center>PERHITUNGAN SPD RAMPUNG</center> </b><br></font>
        <table border="0" cellpadding="7">
            <tr>
                <td style="width:400px">Ditetapkan sejumlah</td>
                <td>: {{rupiah(($hari->d * $data->kwitansi->uang_harian) + $data->kwitansi->tiket + $data->kwitansi->taxi + $data->kwitansi->penginapan)}}</td>
            </tr>
            <tr>
        ...
        <table>
            <tr>
                ...
                <td style="width:400px">Pejabat Pembuat Komitmen,</td>
            </tr>
            <tr>
                <td></td>
                <td><br><br><br>({{$pejabat->nama_ppk}})</td>
            </tr>
            <tr>
                <td></td>
    ...
    <?php     			
			...
			header("content-disposition: attachment;filename=Kwitansi $surat->no_surat.doc"); 
    ?>
</html>