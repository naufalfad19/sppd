          ...
          render: function(data, type, full, meta) {
            ...
            return ``+
              @if(Sentinel::getUser()->hasAccess(['tugas.updt']))
                  ` <a class="btn btn-success btn-sm" href="`+base+'/surat-tugas/'+data+`/edit">@lang('global.app_edit') {{$name}}</a>`+
              @endif
              @if(Sentinel::getUser()->hasAccess(['tugas.destroy']))
                  ` <a class="btn btn-danger btn-sm fa fa-trash" onclick="delete_surat(`+data+`)" href="javascript::void(0)">@lang('global.app_delete') {{$name}}</a>`+
              @endif
          ...
          render: function(data, type, full, meta) {
            ...
            return ``+
              @if(Sentinel::getUser()->hasAccess(['perintah.create']))
                  ` <a class="btn btn-success btn-sm fa fa-file" title="Buat Surat Perintah" href="`+base+'/surat-perintah/create/'+data+`">Form SPPD</a>`+
              @endif
              @if(Sentinel::getUser()->hasAccess(['tugas.show']))
                  ` <a class="btn btn-success btn-sm" href="`+base+'/surat-tugas/'+data+`{{isset($_GET['jenis_perintah']) ? '?jenis_perintah='.$_GET['jenis_perintah'] : ''}}">Kwitansi</a>`+
              @endif
              @if(Sentinel::getUser()->hasAccess(['tugas.updt']))
                  ` <a class="btn btn-success btn-sm" href="`+base+'/surat-tugas/'+data+`/edit">@lang('global.app_edit') {{$name}}</a>`+
              @endif
              ...
              @endif
              @if(Sentinel::getUser()->hasAccess(['tugas.cetak']))
                  ` <a class="btn btn-info btn-sm fa fa-file" title="Cetak Surat Tugas"  href="`+base+'/surat-tugas/'+data+`/cetak">Cetak ST</a>`+
              @endif
              @if(Sentinel::getUser()->hasAccess(['perintah.cetak']))
                  ` <a class="btn btn-info btn-sm fa fa-file" title="Cetak SPPD"  href="`+base+'/surat-perintah/'+data+`/cetak">Cetak SPPD</a>`+
              @endif
              @if(Sentinel::getUser()->hasAccess(['perintah.lpd']))
                  ` <a class="btn btn-info btn-sm fa fa-file" title="Cetak Laporan Perjalanan Dinas"  href="`+base+'/surat-perintah/'+data+`/lpd">Laporan</a>`+
              @endif
                  ``;
          },
        },
      ...
      columnDefs: [
        {
          ...
          render: function(data, type, full, meta) {
            ...
            return ``+
              @if(Sentinel::getUser()->hasAccess(['tugas.show']))
                  ` <a class="btn btn-success btn-sm" href="`+base+'/surat-tugas/'+data+`{{isset($_GET['jenis_perintah']) ? '?jenis_perintah='.$_GET['jenis_perintah'] : ''}} title="Kwitansi"></a>`+
              @endif
              @if(Sentinel::getUser()->hasAccess(['tugas.updt']))
                  ` <a class="btn btn-success btn-sm" href="`+base+'/surat-tugas/'+data+`/edit">@lang('global.app_edit') {{$name}}</a>`+
              @endif
              @if(Sentinel::getUser()->hasAccess(['tugas.destroy']))
                  ` <a class="btn btn-danger btn-sm" onclick="delete_surat(`+data+`)" href="javascript::void(0)">@lang('global.app_delete') {{$name}}</a>`+
              @endif
              @if(Sentinel::getUser()->hasAccess(['tugas.cetak']))
                  ` <a class="btn btn-info btn-sm fa fa-file" title="Cetak Surat Tugas"  href="`+base+'/surat-tugas/'+data+`/cetak">Cetak ST</a>`+
              @endif
              @if(Sentinel::getUser()->hasAccess(['tugas.absen']))
                  ` <a class="btn btn-info btn-sm fa fa-file" title="Cetak Daftar Hadir"  href="`+base+'/surat-tugas/'+data+`/absen">Daftar Hadir</a>`+
              @endif
                  ``;
          },
        },
