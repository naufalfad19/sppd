...
<head>
    ...
    <title>{{ config('app.name') }} | Log App</title>
    {{-- Styles --}}
...
<body>
    <nav class="navbar navbar-expand-md navbar-dark sticky-top bg-dark p-0">
        <a href="{{ route('log-viewer::logs.dashboard') }}" class="navbar-brand mr-0">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item {{ Route::is('log-viewer::logs.dashboard') ? 'active' : '' }}">
                    <a href="{{ route('log-viewer::logs.dashboard') }}" class="nav-link">
