...
$(document).ready(function(){
    ...
    $("#filer_input1").filer({
		...
		files: [
			{
				...
				size: 145,
				type: "image/jpg",
				file: "../editor/assets/images/file-upload/Desert.jpg"
			},
			{
				name: "overflow.jpg",
				size: 145,
        ...
        onRemove: function(itemEl, file, id, listEl, boxEl, newInputEl, inputEl){
            var file = file.name;
						console.log([file,itemEl, file, id, listEl, boxEl, newInputEl, inputEl]);
        ...
        captions: {
            ...
            removeConfirmation: "TOMBOL IKO DAK ADO FUNGSINYO DO, TUH MALEH LOH MENGHAPUSNYO!!!",
            errors: {
